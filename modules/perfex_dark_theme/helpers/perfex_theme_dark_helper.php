...
if (get_option('perfex_dark_theme_customers') == '1') {
    ...
    hooks()->add_action('app_external_form_head', 'app_client_dark_head_custom_includes');
...
function app_client_dark_head_custom_includes()
{
    echo '<link href="' . base_url('modules/perfex_dark_theme/assets/css/clients/clients.css') . '"  rel="stylesheet" type="text/css" >';
    ...
    echo '<script src="' . module_dir_url('perfex_dark_theme', 'assets/js/common.js') . '"></script>';
    echo '<link href="' . base_url('modules/perfex_dark_theme/assets/css/clients/common.css') . '"  rel="stylesheet" type="text/css" >';
}
