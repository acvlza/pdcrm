...
class File_sharing_model extends App_Model
{
     ...
     * @return object
     */
    public function get_file_share($hash)
    {
        $CI = &get_instance();
        ...
        foreach ($file_share as $key => $value) {
            if($value['expiration_date_apply'] == 1 && strtotime($value['expiration_date_apply']) > strtotime(date('Y-m-d'))){
     ...
     * @return object
     */
    public function get_file_share_by_target($target)
    {
        $CI = &get_instance();
