 ...
 */
	...
	class Check_permission extends CI_Controller
	{
	    ...
	    {	
    		...
    		if($mime_type == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" || $mime_type == "application/vnd.openxmlformats-officedocument.wordprocessingml.document" || $mime_type =="application/vnd.openxmlformats-officedocument.presentationml.presentation"){
    			return true;
    		}
	    	...
	    	if (is_client_logged_in()) {
	    		...
	    		if (!(strpos($path, FILE_SHARING_FOLDER_NAME.'/Public/') === false)) {
	    			return true;
	    		}
