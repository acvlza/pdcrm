...
<a href="<?php echo site_url('video_library/client_video_requests/add/'.$project->id); ?>"  class="btn btn-default pull-right mtop5"><?php echo _l('Request Current Version'); ?></a>
