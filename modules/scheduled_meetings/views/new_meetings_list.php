        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="<?php echo admin_url('scheduled_meetings/create_new_meeting'); ?>"
                    class="btn btn-primary tw-mb-2 sm:tw-mb-4 pull-right">
                ...
                <div class="panel_s">
                	<div class="panel-body">
                		<div class="_buttons">
                			<div class="row">
                				<div class="col-md-6">
                					<h4><?php echo _l('scheduled_meetings_new_meetings'); ?> </h4>
                				</div>
...
<?php init_tail(); ?>
<script>
initDataTable('.table-meetings_list', admin_url+"scheduled_meetings/new_meetings_table/", undefined, undefined,undefined,[2,'Desc']);
</script>
