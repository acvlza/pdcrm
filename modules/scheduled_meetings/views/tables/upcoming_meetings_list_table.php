...
$status = '<span class="btn radius badge-light-orange">Upcoming</span>';//new (for upcoming)
}else if($aRow['status'] == 2){
$status = '<span class="btn radius badge-light-orange">Upcoming</span>';//rescheduled  (for upcoming)
