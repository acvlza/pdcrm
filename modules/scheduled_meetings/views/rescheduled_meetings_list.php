                ...
                <div class="panel_s">
                	<div class="panel-body">
                		<div class="_buttons">
                			<div class="row">
                				<div class="col-md-6">
                					<h4><?php echo _l('scheduled_meetings_reschedule_requests'); ?> </h4>
                				</div>
...
<?php init_tail(); ?>
<script>
initDataTable('.table-meetings_list', admin_url+"scheduled_meetings/rescheduled_meetings_table/", undefined, undefined,undefined,[2,'Desc']);
</script>
