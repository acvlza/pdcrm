                ...
                <div class="panel_s">
                	<div class="panel-body">
                		<div class="_buttons">
                			<div class="row">
                				<div class="col-md-6">
                					<h4><?php echo _l('scheduled_meetings_links_list'); ?> </h4>
                				</div>
...
_l('scheduled_meetings_web_url'),
_l('scheduled_meetings_app_url'),
...
<?php init_tail(); ?>
<script>
initDataTable('.table-meetings_list', admin_url+"scheduled_meetings/meetings_link_list_table/", undefined, undefined,undefined,[2,'Desc']);
</script>
</body>
</html>