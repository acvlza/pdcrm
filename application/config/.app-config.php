...
*
*/
define('APP_BASE_URL', 'https://pd.treb.co.za/');
...
*/
define('APP_ENC_KEY', '0c9b16a496d0465c066cb925c28a9e83');
 ...
 */
define('APP_DB_USERNAME', 'trebco_pd');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'pY69q2p!FWU,');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'trebco_pd');
