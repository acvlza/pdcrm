        ...
        <div class="panel_s tw-mt-6 sm:tw-mt-8">
            <div class="panel-body tc-content contract-html-content">
                <table>
                    <tr> 
                        <td>
                            <b><h4 class="tw-my-0 tw-font-semibold contract-html-subject"><?php echo $contract->subject; ?> </h4></b>
                        </td>
                    </tr>
                </table>
                <hr>
                <table>
                    <tr> 
                        <td>
                            <b><h5 class="tw-my-0 tw-font-semibold contract-html-subject">Project Details</h4></b>
                        </td>
                    </tr>
                    ...
                    <tr> 
                        ...
                        <td><?php echo date('F d, Y', strtotime(get_project_startdate($contract->project_id))); ?> - <?php echo date('F d, Y', strtotime(get_project_deadline($contract->project_id))); ?>
                </td>
                ...
                <table class="table dt-table" data-order-col="0" data-order-type="asc">
                    <thead>
                        <tr>
                            ...
                            <th width="20%"><?php echo 'Tasks'; ?></th>
                            <th width="10%"><?php echo 'Schedule'; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                    ...
                    <div class="row mtop20">
                        ...
                        <div class="tw-text-normal col-md-7 contract-start-date tw-text-neutral-700">
                            <?php
                                ...
                                $formattedDate = date('F d, Y', strtotime($datestart));
                                echo $formattedDate;
                            ?>
                        </div>
